...
void checkArgsIs(const char* name, int expected, int got)
{
...
void checkArgsBetween(const char* name, int min, int max, int got)
{
...
void checkArgsAtLeast(const char* name, int min, int got)
{
    MAL_CHECK(got >= min,
...
void checkArgsEven(const char* name, int got)
{
    MAL_CHECK(got % 2 == 0,
